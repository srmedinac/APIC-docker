...
_GFD_PATH = os.path.join(os.path.dirname(__file__), "GraphFeatureDescription.mat")


def get_graph_features(x, y):
    # Load data from GraphFeatureDescription.mat (module-relative; original used a cwd-relative path)
    data = loadmat(_GFD_PATH)
